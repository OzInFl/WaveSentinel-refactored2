...
void ui_scrWifiApps_screen_init(void)
{
    ...
    lv_obj_set_height(ui_txtWifiScanNetsFound, 103);
    lv_obj_set_x(ui_txtWifiScanNetsFound, 1);
    lv_obj_set_y(ui_txtWifiScanNetsFound, -88);
    ...
    lv_obj_set_x(ui_lblWifiScanNetsFound, 2);
    lv_obj_set_y(ui_lblWifiScanNetsFound, -149);
    ...
    lv_obj_set_y(ui_ddlWifiSSID, 12);
    ...
    ui_txtwifiKey = lv_textarea_create(ui_WifiScan);
    lv_obj_set_width(ui_txtwifiKey, 292);
    lv_obj_set_height(ui_txtwifiKey, 34);
    lv_obj_set_x(ui_txtwifiKey, 0);
    lv_obj_set_y(ui_txtwifiKey, 74);
    lv_obj_set_align(ui_txtwifiKey, LV_ALIGN_CENTER);
    lv_textarea_set_text(ui_txtwifiKey, "32012345678");
    lv_textarea_set_placeholder_text(ui_txtwifiKey, "Placeholder...");

    ui_lblWifiKey = lv_label_create(ui_WifiScan);
    lv_obj_set_width(ui_lblWifiKey, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_lblWifiKey, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_lblWifiKey, 0);
    lv_obj_set_y(ui_lblWifiKey, 46);
    lv_obj_set_align(ui_lblWifiKey, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblWifiKey, "WIFI KEY:");
    lv_obj_set_style_text_color(ui_lblWifiKey, lv_color_hex(0xFCFCFC), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_lblWifiKey, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_lblBSSID = lv_label_create(ui_WifiScan);
    lv_obj_set_width(ui_lblBSSID, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_lblBSSID, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_lblBSSID, 0);
    lv_obj_set_y(ui_lblBSSID, -17);
    lv_obj_set_align(ui_lblBSSID, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblBSSID, "Station (BSSID):");
    lv_obj_set_style_text_color(ui_lblBSSID, lv_color_hex(0xFCFCFC), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_lblBSSID, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_imgWifi2 = lv_img_create(ui_scrWifiApps);
    lv_img_set_src(ui_imgWifi2, &ui_img_rxind_png);
    lv_obj_set_width(ui_imgWifi2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_imgWifi2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_imgWifi2, 140);
    lv_obj_set_y(ui_imgWifi2, -221);
    lv_obj_set_align(ui_imgWifi2, LV_ALIGN_CENTER);
    ...
    lv_obj_add_event_cb(ui_txtwifiKey, ui_event_txtwifiKey, LV_EVENT_ALL, NULL);
